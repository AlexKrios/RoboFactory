...
{
    [CustomEditor(typeof(WeaponProductScriptable))]
    [CanEditMultipleObjects]
    public class WeaponProductScriptableEditor : ProductScriptableEditorBase
    {
        private WeaponProductScriptable _productData;
        ...
        private void Awake()
        {
            _productData = (WeaponProductScriptable) target;
        ...
        {
            var weaponArray = Enum.GetNames(typeof(WeaponType));
            ...
            _productData.ProductType = EditorGUILayout.Popup("Weapon Type:", _productData.ProductType, weaponArray);

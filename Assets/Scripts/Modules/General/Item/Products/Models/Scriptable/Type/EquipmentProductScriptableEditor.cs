...
{
    [CustomEditor(typeof(EquipmentProductScriptable))]
    public class EquipmentProductScriptableEditor : ProductScriptableEditorBase
    {
        private EquipmentProductScriptable _productData;
        ...
        private void Awake()
        {
            _productData = (EquipmentProductScriptable) target;
        ...
        {
            var equipmentArray = Enum.GetNames(typeof(EquipmentType));
            ...
            _productData.ProductType = EditorGUILayout.Popup("Equipment Type:", _productData.ProductType, equipmentArray);

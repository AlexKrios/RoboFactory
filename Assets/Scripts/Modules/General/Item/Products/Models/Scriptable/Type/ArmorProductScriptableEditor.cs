...
namespace Modules.General.Item.Products.Models.Scriptable.Type
{
    ...
    {
        private ArmorProductScriptable _productData;
        ...
        private void Awake()
        {
            _productData = (ArmorProductScriptable) target;
        ...
        {
            var armorArray = Enum.GetNames(typeof(ArmorType));
            ...
            _productData.ProductType = EditorGUILayout.Popup("Armor Type:", _productData.ProductType, armorArray);

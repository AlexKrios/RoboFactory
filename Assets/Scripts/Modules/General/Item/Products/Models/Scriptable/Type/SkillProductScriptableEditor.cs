...
{
    [CustomEditor(typeof(SkillProductScriptable))]
    [CanEditMultipleObjects]
    public class SkillProductScriptableEditor : ProductScriptableEditorBase
    {
        private SkillProductScriptable _productData;
        ...
        private void Awake()
        { 
            _productData = (SkillProductScriptable) target;
        ...
        {
            var skillType = Enum.GetNames(typeof(SkillType));
            ...
            _productData.ProductType = EditorGUILayout.Popup("Skill Type:", _productData.ProductType, skillType);

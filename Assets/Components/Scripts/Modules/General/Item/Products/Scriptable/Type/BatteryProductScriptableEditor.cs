...
{
    [CustomEditor(typeof(BatteryProductScriptable))]
    [CanEditMultipleObjects]
    public class BatteryProductScriptableEditor : ProductScriptableEditorBase
    {
        private BatteryProductScriptable _productData;
        ...
        private void Awake()
        { 
            _productData = (BatteryProductScriptable) target;
        ...
        {
            var batteryArray = Enum.GetNames(typeof(BatteryType));
            ...
            _productData.ProductType = EditorGUILayout.Popup("Battery Type:", _productData.ProductType, batteryArray);
